#include "sh1107_font.h"

// Each character in the 6x8 font is represented by a 6-byte array
// The array contains the bitmap data for characters 
// from 0x20 (space) to 0x7F (tilde)
